...
use crate::{cc_builder, target, target_arch, target_os, target_vendor, OutputLibType};
...
impl PlatformConfig {
    fn libcrypto(&self) -> Library {
        match self {
            PlatformConfig::aarch64_apple_darwin => {
                cc_builder::aarch64_apple_darwin_crypto::CRYPTO_LIBRARY
            }
            PlatformConfig::aarch64_unknown_linux_gnu => panic!(""),
            PlatformConfig::aarch64_unknown_linux_musl => panic!(""),
            PlatformConfig::x86_64_apple_darwin => panic!(""),
            PlatformConfig::x86_64_unknown_linux_gnu => panic!(""),
            PlatformConfig::x86_64_unknown_linux_musl => panic!(""),
            PlatformConfig::i686_unknown_linux_gnu => panic!(""),
        }
    }
