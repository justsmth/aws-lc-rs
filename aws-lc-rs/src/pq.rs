...
use aws_lc::{
    d2i_PrivateKey, CBB_init, EVP_PKEY_CTX_new_id, EVP_PKEY_CTX_pqdsa_set_params, EVP_PKEY_keygen,
    EVP_PKEY_keygen_init, EVP_PKEY_pqdsa_new_raw_public_key, EVP_marshal_private_key,
...
mod tests {
    use crate::pq::{
        evp_key_pqdsa_generate, evp_pkey_from_private, evp_pkey_from_public,
        marshal_private_key_to_buffer, marshal_public_key_to_buffer,
    };
